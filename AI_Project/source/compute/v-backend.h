...
size_t v_get_backend_buffer_alloc_size(v_backend_buffer_type_t buft, const struct v_tensor* tensor);
...
void v_backend_tensor_cpy(struct v_tensor* src, struct v_tensor* dst);
...
void v_get_backend_tensor(const struct v_tensor* tensor, void* data, size_t offset, size_t size);
...
v_API enum v_status v_backend_tensor_alloc(v_backend_buffer_t buffer, struct v_tensor* tensor, void* addr);
v_API enum v_status v_backend_tensor_view_init(struct v_tensor* tensor);
...
void vk_device_buffer_memset_tensor(v_backend_buffer_t buffer, struct v_tensor* tensor, uint8_t value, size_t offset, size_t size);
