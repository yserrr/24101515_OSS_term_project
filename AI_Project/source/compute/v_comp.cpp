...
v_tensor_t v_add_imple(struct v_ctx* ctx,
                             v_tensor_t a,
                             v_tensor_t b,
                             bool inplace) {
  V_ASSERT(can_repeat(b, a));
  v_tensor_t result = inplace
                              ? v_tensor_view(ctx, a)
                              : v_dup_tensor(ctx, a);
  result->op     = v_OP_ADD;
  result->src[0] = a;
...
v_tensor_t v_set_zero(v_tensor_t tensor) {
  if (is_empty(tensor)) {
    return tensor;
  }
  if (tensor->buffer) {
...
v_tensor_t v_unary_impl(struct v_ctx* ctx,
                              v_tensor_t a,
                              enum v_unary_op op,
                              bool inplace) {
...
v_tensor_t v_get_rows(struct v_ctx* ctx,
                            v_tensor_t a,
                            v_tensor_t b) {
  ...
  v_tensor_t result = v_new_tensor_4d(ctx, type, a->ne[0], b->ne[0], b->ne[1], b->ne[2]);
...
v_tensor_t v_get_rows_back(struct v_ctx* ctx,
                                    v_tensor_t a,
                                    v_tensor_t b,
                                    v_tensor_t c) {
  ...
  v_tensor_t result = v_new_tensor_2d(ctx, v_TYPE_F32, c->ne[0], c->ne[1]);
...
v_tensor_t v_diag(struct v_ctx* ctx,
                        v_tensor_t a) {
  V_ASSERT(a->ne[1] == 1);

  const int64_t ne[4]     = {a->ne[0], a->ne[0], a->ne[2], a->ne[3]};
  v_tensor_t result = v_new_tensor(ctx, a->type, 4, ne);
...
v_tensor_t v_out_prod(struct v_ctx* ctx,
                            v_tensor_t a,
                            v_tensor_t b) {
  ...
  v_tensor_t result = v_new_tensor(ctx, v_TYPE_F32, 4, ne);
...
v_tensor_t v_silu_back(
  struct v_ctx* ctx,
  v_tensor_t a,
  v_tensor_t b) {
  v_tensor_t result = v_dup_tensor(ctx, a);
...
v_tensor_t v_glu_impl(struct v_ctx* ctx,
                               v_tensor_t a,
                               v_tensor_t b,
                               enum v_glu_op op,
                               bool swapped) {
  ...
  v_tensor_t result = new_tensor_impl(ctx, a->type, V_MAX_DIMS, b
                                                                          ? a->ne
                                                                          : ne, NULL, 0);
...
v_tensor_t v_repeat_4d(struct v_ctx* ctx,
                                v_tensor_t a,
                                int64_t ne0,
                                int64_t ne1,
                                int64_t ne2,
  ...
  v_tensor_t result = v_new_tensor_4d(ctx, a->type, ne0, ne1, ne2, ne3);
...
v_tensor_t v_permute(struct v_ctx* ctx,
                           v_tensor_t a,
                           int axis0,
                           int axis1,
                           int axis2,
  ...
  v_tensor_t result = v_tensor_view(ctx, a);
...
v_tensor_t v_set_rows(struct v_ctx* ctx,
                            v_tensor_t a,
                            v_tensor_t b,
                            v_tensor_t c) {
...
v_tensor_t v_transpose(struct v_ctx* ctx,
                             v_tensor_t a) {
  v_tensor_t result = v_tensor_view(ctx, a);
...
v_tensor_t v_div_impl(struct v_ctx* ctx,
                            v_tensor_t a,
                            v_tensor_t b,
                            bool inplace) {
  V_ASSERT(can_repeat(b, a));
...
v_tensor_t v_sqr_impl(struct v_ctx* ctx,
                               v_tensor_t a,
                               bool inplace) {
  v_tensor_t result = inplace
                              ? v_tensor_view(ctx, a)
...
v_tensor_t v_sqrt_impl(struct v_ctx* ctx,
                                v_tensor_t a,
                                bool inplace) {
  v_tensor_t result = inplace
                              ? v_tensor_view(ctx, a)
...
v_tensor_t v_sum_rows(struct v_ctx* ctx,
                               v_tensor_t a) {
  ...
  v_tensor_t result = v_new_tensor(ctx, a->type, V_MAX_DIMS, ne);
...
v_tensor_t v_mean(struct v_ctx* ctx,
                           v_tensor_t a) {
...
v_tensor_t v_sum(struct v_ctx* ctx,
                       v_tensor_t a) {
  v_tensor_t result = v_new_tensor_1d(ctx, a->type, 1);
...
v_tensor_t mmlSubImpl(struct v_ctx* ctx,
                            v_tensor_t a,
                            v_tensor_t b,
                            bool inplace) {
  V_ASSERT(can_repeat(b, a));
...
v_tensor_t add_cast_impl(struct v_ctx* ctx,
                               v_tensor_t a,
                               v_tensor_t b,
  ...
  v_tensor_t result = v_new_tensor(ctx, type, V_MAX_DIMS, a->ne);
...
v_tensor_t v_mul_impl(struct v_ctx* ctx,
                               v_tensor_t a,
                               v_tensor_t b,
                               bool inplace) {
  V_ASSERT(can_repeat(b, a));
...
v_tensor_t v_matmul(struct v_ctx* ctx,
                          v_tensor_t a,
                          v_tensor_t b) {
...
v_tensor_t v_l2_norm_impl(struct v_ctx* ctx,
                                   v_tensor_t a,
                                   float eps,
                                   bool inplace) {
  v_tensor_t result = inplace
...
v_tensor_t v_dup_impl(struct v_ctx* ctx,
                               v_tensor_t a,
                               bool inplace) {
  v_tensor_t result = inplace
                              ? v_tensor_view(ctx, a)
...
v_tensor_t add_id(struct v_ctx* ctx,
                        v_tensor_t a,
                        v_tensor_t b,
                        v_tensor_t ids) {
  V_ASSERT(a->ne[0] == b->ne[0]);
...
v_tensor_t v_sin_impl(struct v_ctx* ctx,
                               v_tensor_t a,
                               bool inplace) {
  v_tensor_t result = inplace
                              ? v_tensor_view(ctx, a)
...
v_tensor_t v_log_impl(struct v_ctx* ctx,
                               v_tensor_t a,
                               bool inplace) {
  v_tensor_t result = inplace
                              ? v_tensor_view(ctx, a)
...
v_tensor_t v_argmax(struct v_ctx* ctx,
                          v_tensor_t a) {
  V_ASSERT(v_is_matrix(a));
  V_ASSERT(a->ne[0] <= INT32_MAX);

  v_tensor_t result = v_new_tensor_1d(ctx, v_TYPE_I32, a->ne[1]);
  result->op              = V_OP_ARGMAX;
  result->src[0]          = a;
  return result;
}

v_tensor_t v_count_equal(struct v_ctx* ctx,
                                  v_tensor_t a,
                                  v_tensor_t b) {
  V_ASSERT(v_are_same_shape(a, b));

  v_tensor_t result = v_new_tensor_1d(ctx, v_TYPE_I64, 1);
...
v_tensor_t v_repeat(struct v_ctx* ctx,
                             v_tensor_t a,
                             v_tensor_t b) {
  V_ASSERT(can_repeat(a, b));

  v_tensor_t result = v_new_tensor(ctx, a->type, V_MAX_DIMS, b->ne);
...
v_tensor_t v_repeat_back(struct v_ctx* ctx,
                                  v_tensor_t a,
                                  v_tensor_t b) {
  V_ASSERT(can_repeat(b, a));
...
v_tensor_t v_leaky_relu(struct v_ctx* ctx,
                                 v_tensor_t a,
...
v_tensor_t v_xielu(struct v_ctx* ctx,
                            v_tensor_t a,
                            float alpha_n,
                            float alpha_p,
                            float beta,
...
v_tensor_t v_swiglu_oai(struct v_ctx* ctx,
                                 v_tensor_t a,
                                 v_tensor_t b,
                                 float alpha,
                                 float limit) {
  v_tensor_t result = v_glu_impl(ctx, a, b, v_GLU_OP_SWIGLU_OAI, false);
  v_set_op_params_f32(result, 2, alpha);
  v_set_op_params_f32(result, 3, limit);
  return result;
}

v_tensor_t v_norm_impl(struct v_ctx* ctx,
                                v_tensor_t a,
                                float eps,
                                bool inplace) {
  v_tensor_t result = inplace
...
v_tensor_t v_rms_norm_impl(struct v_ctx* ctx,
                                    v_tensor_t a,
                                    float eps,
                                    bool inplace) {
  v_tensor_t result = inplace
...
v_tensor_t v_rms_norm_back(struct v_ctx* ctx,
                                    v_tensor_t a,
                                    v_tensor_t b,
                                    float eps) {
  v_tensor_t result = v_dup_tensor(ctx, a);
...
v_tensor_t v_group_norm_impl(struct v_ctx* ctx,
                                   v_tensor_t a,
                                   int n_groups,
                                   float eps,
                                   bool inplace) {
...
*/
v_tensor_t mmlMatrixMulId(struct v_ctx* ctx,
                                v_tensor_t as,
                                v_tensor_t b,
                                v_tensor_t ids) {
...
v_tensor_t v_scale_impl(struct v_ctx* ctx,
                              v_tensor_t a,
                              float s,
                              float b,
                              bool inplace) {
...
v_tensor_t v_cast(struct v_ctx* ctx,
                        v_tensor_t a,
                        enum v_data_type type) {
  v_tensor_t result = v_new_tensor(ctx, type, V_MAX_DIMS, a->ne);
...
v_tensor_t v_mem_cont(struct v_ctx* ctx,
                            v_tensor_t a) {
  v_tensor_t result = v_dup_tensor(ctx, a);
