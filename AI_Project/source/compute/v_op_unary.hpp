...
//
//v_tensor* v_sqr(v_ctx* ctx, v_tensor* a);
//v_tensor* v_sqr_inplace(v_ctx* ctx, v_tensor* a);
//v_tensor* v_sqrt(v_ctx* ctx, v_tensor* a);
//v_tensor* v_sqrt_inplace(v_ctx* ctx, v_tensor* a);
//v_tensor* v_log(v_ctx* ctx, v_tensor* a);
//v_tensor* v_log_inplace(v_ctx* ctx, v_tensor* a);
//v_tensor* v_sin(v_ctx* ctx, v_tensor* a);
//v_tensor* v_sin_inplace(v_ctx* ctx, v_tensor* a);
//v_tensor* v_cos(v_ctx* ctx, v_tensor* a);
//v_tensor* v_cos_inplace(v_ctx* ctx, v_tensor* a);
///**
