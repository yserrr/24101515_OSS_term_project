 ...
 * VkGraphCompiler warnings or even errors when a gl.h is already included.
 ...
 * Presumably everybody is using platform default VkGraphCompilers not c99 or else
 * they are using C++.
 */
...
@li compile warnings from VkGraphCompilers stricter than MS Visual C++. Thanks to
    Pavel Rotjberg.
