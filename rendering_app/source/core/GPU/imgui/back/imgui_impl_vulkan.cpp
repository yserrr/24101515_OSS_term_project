...
void ImGui_ImplVulkan_UpdateTexture(ImTextureData* tex)
{
  ...
  if (tex->Status == ImTextureStatus_WantCreate || tex->Status == ImTextureStatus_WantUpdates)
  {
    ...
    // Copy to Image:
    {
      ...
      vkCmdPipelineBarrier(bd->TexCommandBuffer, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT | VK_PIPELINE_STAGE_HOST_BIT,
      ...
      vkCmdPipelineBarrier(bd->TexCommandBuffer, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
...
bool ImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo* info)
{
  ...
  if (v->PipelineRenderingCreateInfo.pColorAttachmentFormats != NULL)
  {
    ...
    VkFormat* formats_copy = (VkFormat*)
      IM_ALLOC(sizeof(VkFormat) * v->PipelineRenderingCreateInfo.colorAttachmentCount);
